...
const services = [
  ...
  },
  {
    ...
    desc: "A DIDComm chatbot that issues verifiable credentials to users through conversational interactions. Connect with Hologram Messaging, follow the guided flow, and receive a Verifiable Credential backed by the Verana Trust Registry. Your credential proves attributes about you and can be verified by any party.",
  ...
  },
  {
    ...
    desc: "A credential issuer that reads NFC data from government-issued identity documents (passports, ID cards) and verifies the holder's identity via a liveness check with video call and gesture detection. Once verified, it issues a passport credential as a Verifiable Credential backed by the Verana Trust Registry.",
